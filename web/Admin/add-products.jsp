                                                    ...
                                                    <form id="productForm" action="${pageContext.request.contextPath}/Admin/addProduct" method="post">
                                                        <div class="card mb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input name="name" id="name" type="text" class="form-control" placeholder="Tên sản phẩm" required value="<c:if test='${not empty copyProduct}'><c:out value='${copyProduct.name}'/></c:if>" />
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="description" class="form-label">Mô tả</label>
                                                                                <textarea name="description" id="description" class="form-control" placeholder="Mô tả" rows="3"><c:if test='${not empty copyProduct}'><c:out value='${copyProduct.description}'/></c:if></textarea>
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <select name="loaiPr" id="loaiPr" class="form-select" required>
                                                                                    <option value="" disabled <c:if test="${empty copyProduct}">selected</c:if>>Chọn loại sản phẩm</option>
                                                                                <option value="1" <c:if test="${copyCategoryId == 1}">selected</c:if>>Smartphones</option>
                                                                                <option value="2" <c:if test="${copyCategoryId == 2}">selected</c:if>>Tablets</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="hangPr" class="form-label">Hãng sản xuất</label>
                                                                                <select name="hangPr" id="hangPr" class="form-select" required>
                                                                                    <option value="" disabled <c:if test="${empty copyProduct}">selected</c:if>>Chọn hãng sản xuất</option>
                                                                                <option value="3" <c:if test="${copyBrandId == 3}">selected</c:if>>Apple</option>
                                                                                <option value="4" <c:if test="${copyBrandId == 4}">selected</c:if>>Samsung</option>
                                                                                <option value="5" <c:if test="${copyBrandId == 5}">selected</c:if>>Oppo</option>
                                                                                <option value="6" <c:if test="${copyBrandId == 6}">selected</c:if>>Xiaomi</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input name="price" id="price" type="number" step="0.01" class="form-control" placeholder="Giá" required value="<c:if test='${not empty copyProduct}'><c:out value='${copyProduct.price}'/></c:if>" />
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="discount" class="form-label">Discount</label>
                                                                                <input name="discount" id="discount" type="number" step="0.01" class="form-control" placeholder="Discount" value="<c:if test='${not empty copyProduct}'><c:out value='${copyProduct.discount}'/></c:if>" />
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="quantity" class="form-label">Số lượng</label>
                                                                                <input name="quantity" id="quantity" type="number" class="form-control" placeholder="Số lượng" required value="<c:if test='${not empty copyProduct}'><c:out value='${copyProduct.quantity}'/></c:if>" />
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="created_at" class="form-label">Ngày tạo</label>
                                                                                        <input name="created_at" id="created_at" type="date" class="form-control" required value="<c:if test='${not empty copyProduct}'><fmt:formatDate value='${copyProduct.created_at}' pattern='yyyy-MM-dd'/></c:if>" />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="mb-3">
                                                                                        <label for="updated_at" class="form-label">Ngày cập nhật</label>
                                                                                        <input name="updated_at" id="updated_at" type="date" class="form-control" required value="<c:if test='${not empty copyProduct}'><fmt:formatDate value='${copyProduct.updated_at}' pattern='yyyy-MM-dd'/></c:if>" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input name="screen" id="screen" type="text" class="form-control" placeholder="Màn hình" value="<c:if test='${not empty copyProductDetails}'><c:out value='${copyProductDetails[0].screen}'/></c:if>" />
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="os" class="form-label">Hệ điều hành</label>
                                                                                <input name="os" id="os" type="text" class="form-control" placeholder="Hệ điều hành" value="<c:if test='${not empty copyProductDetails}'><c:out value='${copyProductDetails[0].os}'/></c:if>" />
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="mCam" class="form-label">Camera chính</label>
                                                                                <input name="mCam" id="mCam" type="text" class="form-control" placeholder="Camera chính" value="<c:if test='${not empty copyProductDetails}'><c:out value='${copyProductDetails[0].mainCamera}'/></c:if>" />
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="sCam" class="form-label">Camera selfie</label>
                                                                                <input name="sCam" id="sCam" type="text" class="form-control" placeholder="Camera selfie" value="<c:if test='${not empty copyProductDetails}'><c:out value='${copyProductDetails[0].selfieCamera}'/></c:if>" />
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="chip" class="form-label">Chip</label>
                                                                                <input name="chip" id="chip" type="text" class="form-control" placeholder="Chip" value="<c:if test='${not empty copyProductDetails}'><c:out value='${copyProductDetails[0].chip}'/></c:if>" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                <label for="ram" class="form-label">RAM</label>
                                                                                <input name="ram" id="ram" type="text" class="form-control" placeholder="RAM" value="<c:if test='${not empty copyProductDetails}'><c:out value='${copyProductDetails[0].ram}'/></c:if>" />
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="sim" class="form-label">SIM</label>
                                                                                <input name="sim" id="sim" type="text" class="form-control" placeholder="SIM" value="<c:if test='${not empty copyProductDetails}'><c:out value='${copyProductDetails[0].sim}'/></c:if>" />
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="pin" class="form-label">Pin</label>
                                                                                <input name="pin" id="pin" type="text" class="form-control" placeholder="Pin" value="<c:if test='${not empty copyProductDetails}'><c:out value='${copyProductDetails[0].battery}'/></c:if>" />
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="sac" class="form-label">Sạc</label>
                                                                                <input name="sac" id="sac" type="text" class="form-control" placeholder="Sạc" value="<c:if test='${not empty copyProductDetails}'><c:out value='${copyProductDetails[0].charger}'/></c:if>" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <textarea name="colors" class="form-control" rows="4" placeholder="Mỗi màu một dòng:&#10;Đỏ&#10;Xanh&#10;Vàng" required><c:if test='${not empty copyProductDetails}'><c:forEach var="detail" items="${copyProductDetails}" varStatus="status"><c:out value='${detail.color}'/><c:if test='${!status.last}'>&#10;</c:if></c:forEach></c:if></textarea>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <textarea name="storages" class="form-control" rows="4" placeholder="Mỗi dung lượng một dòng:&#10;128GB&#10;256GB&#10;512GB" required><c:if test='${not empty copyProductDetails}'><c:forEach var="detail" items="${copyProductDetails}" varStatus="status"><c:out value='${detail.storage}'/><c:if test='${!status.last}'>&#10;</c:if></c:forEach></c:if></textarea>
                                                            ...
                                                            <div class="card mb-3">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input id="thumbnail" name="thumbnail" type="text" class="form-control" placeholder="Ví dụ: iphone15_red.jpg" required value="<c:if test='${not empty copyProduct}'><c:out value='${copyProduct.thumbnail}'/></c:if>" />
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input id="images" name="images" type="text" class="form-control" placeholder="Ví dụ: iphone15_1.jpg,iphone15_2.jpg" value="<c:if test='${not empty copyGalleries}'><c:forEach var='img' items='${copyGalleries}' varStatus='status'>${img}<c:if test='${!status.last}'>,</c:if></c:forEach></c:if>" />
                                                                ...
                                                                <script>
                                                                    // Set today's date as default for date fields only if no copied product
                                                                    document.addEventListener('DOMContentLoaded', function () {
                                                                        const createdAtField = document.getElementById('created_at');
                                                                        const updatedAtField = document.getElementById('updated_at');
                                                                        
                                                                        // Only set default dates if fields are empty (no copied product)
